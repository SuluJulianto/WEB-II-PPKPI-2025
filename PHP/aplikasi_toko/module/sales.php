<?php
// toko/module/sales.php

// Pastikan output adalah JSON dan mulai session
header('Content-Type: application/json');
if (!isset($_SESSION)) {
    session_start();
}

// Memanggil file dbconnect.php dari folder yang sama (__DIR__)
require_once __DIR__ . '/dbconnect.php';

// Sanitasi input dan penanganan aksi
...
function readData() {
    try {
        ...
        return ["response" => 0, "data" => "Database error: " . $e->getMessage()];
    }
}
