...
// Pastikan yang login bukan user biasa
if ($_SESSION['auth_type'] != 'karyawan') {
        ...
        <div class="content">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    <h2 class="card-title">Selamat Datang, <?= htmlspecialchars($current_user) ?>!</h2>
                    <p class="card-text text-muted">Anda telah berhasil login sebagai <?= htmlspecialchars($user_role) ?>. Gunakan menu di samping untuk mulai mengelola aplikasi.</p>
                </div>
            </div>

            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white">
                    <h5 class="mb-0"><i class="fas fa-boxes me-2"></i>Daftar Inventori Saat Ini</h5>
                </div>
                <div class="card-body">
