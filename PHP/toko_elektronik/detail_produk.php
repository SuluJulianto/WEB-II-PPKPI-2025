...
// Jika produk tidak ditemukan, alihkan ke halaman utama
if (!$produk) {
    header('Location: produk_publik.php');
    exit();
}
...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        <div class="container">
            ...
            <div class="ml-auto">
                <a class="btn btn-outline-light" href="login.php"><i class="fas fa-sign-in-alt"></i> Admin Login</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container mt-5">
        <div class="card shadow">
            <div class="row no-gutters">
                <div class="col-md-5">
                    <img src="img/<?php echo htmlspecialchars($produk['thumbnail']); ?>" class="card-img" alt="<?php echo htmlspecialchars($produk['produk']); ?>">
                </div>
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?php 
                            // Tampilkan deskripsi, jika kosong tampilkan pesan default
                            echo !empty($produk['deskripsi']) ? nl2br(htmlspecialchars($produk['deskripsi'])) : 'Deskripsi untuk produk ini belum tersedia.'; 
                            ?>
                        </p>
