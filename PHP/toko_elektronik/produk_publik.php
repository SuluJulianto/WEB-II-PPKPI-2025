...
// Filter dan pencarian (tidak ada perubahan logika)
...
<body class="bg-light">
    ...
    <div class="container mt-5">
        <div class="card shadow">
            <div class="card-header bg-white text-primary font-weight-bold">Daftar Produk Kami</div>
            <div class="card-body">
                <form action="produk_publik.php" method="GET" class="mb-4">
                    <div class="input-group">
                        ...
                        <div class="input-group-append"><button class="btn btn-primary" type="submit"><i class="fas fa-search"></i> Cari</button></div>
                    </div>
                </form>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        <thead class="thead-dark"><tr><th>#</th><th>Gambar</th><th>Nama Produk</th><th>Kategori</th><th>Harga</th><th>Status</th></tr></thead>
                        <tbody>
                            <?php 
                            $no = 1;
                            ...
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td><img src="assets/img/<?php echo htmlspecialchars($data['thumbnail']); ?>" width="120" alt="<?php echo htmlspecialchars($data['produk']); ?>"></td>
                                ...
                                <td><?php if ($data['stok'] > 0) { ?><span class="badge badge-success">Tersedia</span><?php } else { ?><span class="badge badge-danger">Stok Habis</span><?php } ?></td>
                            </tr>
                            <?php } } else { echo '<tr><td colspan="6" class="text-center">Produk tidak ditemukan.</td></tr>'; } ?>
                        </tbody>
                    </table>
                </div>
            </div>
